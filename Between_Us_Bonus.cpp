/*
В края на 2020 Outersloth обявиха новата DLC карта за играта Between Us - Euclidius. Името на картата идва от формата й - двумерна Евклидова равнина. Някои от новите за картата задачи се намират в специално отделение на картата - The Dealy Darkness (TDD). Звучи доста приятелско.

Заедно с новата карта пристига и нова роля - Necromancer. Necromancer-ът е crewmate, но може да съживява хора, които са умрели в TDD (колко добра идея е не знаем...за справка, WarCraft 3). Нашият Necromancer ще се казва Келто (без конкретна причина). Той иска да съживи максимално много crewmates, за да докаже, че е достоен necromancer. По зададена позицията на Келто и на наскоро убития crewmate, отговорете какво е минималното време, за което нашият млад necromancer може да стигне до най-новата си пионка...uhm жертва, до най-новата жертва.

Както казахме, Euclidius е като двумерна Евклидова равнина. Освен това, границата между основната част на картата и TDD е права хоризонтална линия. Нека тази граница е линията y=0. Всяка точка над нея е част от TDD, а всяка точка под нея - от основната част на картата. Скоростта, с която Келто се движи по суша ще бележим с v1, а скоростта му в TDD - с v2 (Скорост дефинираме като евклидовото разстояние, което Келто изминава за единица време). Текущата позиция на Келто ще бележим с (x1, y1) а на убития crewmate - с (x2, y2). Келто се намира в основната част на картата в началото.
